// find vinyl edit form
let vinylEditForm = document.getElementById('vinylEditForm');
// add submit listener to vinyl edit form
vinylEditForm.addEventListener('submit', function(event) {
